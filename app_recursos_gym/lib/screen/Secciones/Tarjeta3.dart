import 'package:app_recursos_gym/screen/Components/ObtenerSucursal.dart';
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SucursalesPage()),
            );
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                bottom: 0,
                child: Card(
                  color: const Color.fromRGBO(226, 244, 250, 1), // Fondo de la segunda tarjeta
